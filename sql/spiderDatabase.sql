...
MySQL - 5.6.29-log : Database - celt_charge
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cct_spider` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
USE `cct_spider`;
 ...
 CREATE TABLE `cct_spider`.`article` (
                      ...
                      `abstract` varchar(32) DEFAULT NULL COMMENT '文章摘要',
 ...
 CREATE TABLE `cct_spider`.`article_info` (
                      `id` int(11) NOT NULL AUTO_INCREMENT,
                      `md5_url` VARCHAR (34) NOT NULL COMMENT '文章url 的md5值(32位)',
                      `content` mediumtext COMMENT '文章标题',
                      `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                      PRIMARY KEY (`id`),
                      KEY `idx_md5_url` (`md5_url`),
                    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ;